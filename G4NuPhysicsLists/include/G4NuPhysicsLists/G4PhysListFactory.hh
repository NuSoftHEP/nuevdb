...
// if/when officially adopted then DEF_G4NU_FACTORY "g4nu" namespace can go away
#define DEF_G4NU_FACTORY 1
#ifdef DEF_G4NU_FACTORY
namespace g4nu {
#endif
...
public:
  ...
  void PrintAvailableLists() const { PrintAvailablePhysLists(); }
