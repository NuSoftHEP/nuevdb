  ...
  )
{
  ...
  try{
    art::ProductID aid = producer.template getProductID< std::vector<T>>( a_instance);
...
bool evgb::util::CreateAssn(
  ...
  try{
    art::ProductID aid = producer.template getProductID< std::vector<T> >();
    art::Ptr<T> aptr(aid, indx, evt.productGetter(aid));
...
bool evgb::util::CreateAssn(
  ...
  try{
    art::ProductID aid = producer.template getProductID< std::vector<T> >();
    art::ProductID bid = producer.template getProductID< std::vector<U> >();
    art::Ptr<T> aptr(aid, indx, evt.productGetter(aid));
