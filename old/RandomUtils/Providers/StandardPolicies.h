...
#ifndef NUTOOLS_RANDOMUTILS_PROVIDERS_STANDARDPOLICIES_H
#define NUTOOLS_RANDOMUTILS_PROVIDERS_STANDARDPOLICIES_H 1
...
#endif // NUTOOLS_RANDOMUTILS_PROVIDERS_STANDARDPOLICIES_H
